...
public struct Tile2bppProperties
{
        ...
        set
        {
            if (value < 0 || value > 15)
                throw new ArgumentOutOfRangeException(nameof(value),
                    "The palette index value should be between 0 and 15.");
    ...
    public int SubPaletteIndex
    {
        ...
        set
        {
            if (value != 0 && value != 4 && value != 8 && value != 12)
                throw new ArgumentOutOfRangeException(nameof(value),
                    "The sub palette index value should be positive, a multiple of 4, and no higher than 12.");
    ...
    public Tile2bppProperties(byte data)
    {
        ...
        if ((paletteData & 0x03) != 0)
            throw new ArgumentOutOfRangeException(nameof(data),
                "Invalid 2bpp tile property data. The 2 lower bits should be 0.");
