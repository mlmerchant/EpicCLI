...
internal class BattleTrack : Track
{
    ...
    {
        byte[] startPosition1Data =
            { startPositionData[0], startPositionData[1], startPositionData[2], startPositionData[3] };
        byte[] startPosition2Data =
            { startPositionData[4], startPositionData[5], startPositionData[6], startPositionData[7] };
    ...
    private void StartPositionP1_DataChanged(object sender, EventArgs e)
    {
        MarkAsModified(PropertyNames.BattleTrack.StartPositionP1);
    }

    private void StartPositionP2_DataChanged(object sender, EventArgs e)
    {
