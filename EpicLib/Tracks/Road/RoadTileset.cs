...
/// </summary>
public class RoadTileset : ITileset, INotifyPropertyChanged, IDisposable
{
    /// <summary>
    ...
    public RoadTileset(RoadTile[] tileset)
    {
        ...
        foreach (Tile tile in _tileset) tile.PropertyChanged += MarkAsModified;
    }
    ...
    public byte[] GetTileGenreBytes()
    {
        ...
        for (var i = 0; i < data.Length; i++) data[i] = (byte)_tileset[i].Genre;
    ...
    public byte[] GetTilePaletteBytes()
    {
        ...
        for (var i = 0; i < _tileset.Length; i++) data[i] = _tileset[i].PaletteByte;
    ...
    public void SetTileGenreBytes(byte[] data)
    {
        ...
        for (var i = 0; i < _tileset.Length; i++) _tileset[i].Genre = (RoadTileGenre)data[i];
    }
    ...
    public void SetTilePaletteBytes(byte[] data)
    {
        ...
        for (var i = 0; i < _tileset.Length; i++) _tileset[i].PaletteByte = data[i];
    }
