...
/// </summary>
public class ItemProbabilities : INotifyPropertyChanged
{
    /// <summary>
    ...
    public void SetBytes(byte[] data)
    {
        if (data.Length != Size)
            throw new ArgumentException(
                $"Item probabilities data should have a size of {Size} bytes. Actual: {data.Length} bytes.",
                nameof(data));
    ...
    {
        foreach (var itemProba in _itemProbabilities) itemProba.ResetModifiedState();
    }
