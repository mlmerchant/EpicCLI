...
/// </summary>
public class ItemProbability : INotifyPropertyChanged
{
    /// <summary>
    ...
    {
        if (SubTotal - field + value > TotalCount) value = TotalCount - (SubTotal - field);
    ...
    private int SubTotal
    {
        get
        {
            ...
            for (var i = 0; i < _values.Length; i++) value += _values[i];
